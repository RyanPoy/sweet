...
def example():
    ...
    print '\n***** create post which category name is 数码 and user_id is 2'
    Category.find_by_name('数码').posts.create(title=u'互联网公司火拼基金销售', content=u'''余额宝和百发分别对接的是天弘基金的天弘增利宝和华夏基金的华夏现金增利货币E，
        ...
        基金公司需要网站分成30%-40%的管理费。''', user=User.find(2))
