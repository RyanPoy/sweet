...
import unittest
from tests.integration.for_sqlite.helper import AbsModel, User, Mobile, Car, Tag, Article, Course, Student, Score, db_mgr
from tests.integration.for_sqlite.helper import StudentForHasOneThrough as Student2, CourseForHasOneThrough as Course2, ScoreForHasOneThrough as Score2
from sweet_orm.orm import Model
from sweet.record import SQLite
from sweet.record.recordset import SQLiteRecordset
from sweet.record.collection import Collection, MemCollection
...
class TestRelationIncludeSQLite(unittest.TestCase):
    ...
    def test_include_belongs_to(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?)', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?)', FakeDB.SQLS[2])
            self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?)', FakeDB.SQLS[3])
            self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?)', FakeDB.SQLS[4])
    ...
    def test_include_has_many(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual('SELECT * FROM `mobiles` WHERE `user_id` = ?', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `mobiles` WHERE `user_id` = ?', FakeDB.SQLS[2])
        ...
        with self.mock_db():
            ...
            self.assertEqual(2, len(FakeDB.SQLS))
            self.assertEqual('SELECT * FROM `users`', FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `mobiles` WHERE `user_id` IN (?, ?)', FakeDB.SQLS[1])
    ...
    def test_include_has_one(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual(3, len(FakeDB.SQLS))
            self.assertEqual('SELECT * FROM `users`', FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `cars` WHERE `user_id` = ?', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `cars` WHERE `user_id` = ?', FakeDB.SQLS[2])
        ...
        with self.mock_db():
            ...
            self.assertEqual(2, len(FakeDB.SQLS))
            self.assertEqual('SELECT * FROM `users`', FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `cars` WHERE `user_id` IN (?, ?)', FakeDB.SQLS[1])
    ...
    def test_include_has_many_through(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual("SELECT * FROM `courses` "
                             ...
                             "WHERE `scores`.`student_id` = ?", FakeDB.SQLS[1])
            self.assertEqual("SELECT * FROM `courses` "
                             "INNER JOIN `scores` ON `courses`.`id` = `scores`.`course_id` "
                             "INNER JOIN `students` ON `students`.`id` = `scores`.`student_id` "
                             "WHERE `scores`.`student_id` = ?", FakeDB.SQLS[2])
            self.assertEqual("SELECT * FROM `courses` "
                             "INNER JOIN `scores` ON `courses`.`id` = `scores`.`course_id` "
                             "INNER JOIN `students` ON `students`.`id` = `scores`.`student_id` "
                             "WHERE `scores`.`student_id` = ?", FakeDB.SQLS[3])
        ...
        with self.mock_db():
            ...
            self.assertEqual(3, len(FakeDB.SQLS))
            self.assertEqual('SELECT * FROM `students`', FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `scores` WHERE `student_id` IN (?, ?, ?)', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `courses` WHERE `id` IN (?, ?, ?, ?, ?, ?, ?, ?, ?)', FakeDB.SQLS[2])
    ...
    def test_include_has_one_through(self):
        ...
        with self.mock_db():
            ...
            for s in Student2.where(name__not='Ryan').all():
                ...
                c.name
            self.assertEqual(4, len(FakeDB.SQLS))
            self.assertEqual("SELECT * FROM `students` WHERE `name` <> ?", FakeDB.SQLS[0])
            self.assertEqual("SELECT * FROM `courses` "
                             "INNER JOIN `scores` ON `courses`.`id` = `scores`.`course_id` "
                             "INNER JOIN `students` ON `students`.`id` = `scores`.`student_id` "
                             "WHERE `scores`.`student_id` = ?", FakeDB.SQLS[1])
    ...
    def test_include_has_and_belongs_to_many(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual("SELECT * FROM `articles` "
                             ...
                             "WHERE `articles_tags`.`tag_id` = ?", FakeDB.SQLS[1])
            self.assertEqual("SELECT * FROM `articles` "
                             "INNER JOIN `articles_tags` ON `articles`.`id` = `articles_tags`.`article_id` "
                             "INNER JOIN `tags` ON `tags`.`id` = `articles_tags`.`tag_id` "
                             "WHERE `articles_tags`.`tag_id` = ?", FakeDB.SQLS[2])
            self.assertEqual("SELECT * FROM `articles` "
                             "INNER JOIN `articles_tags` ON `articles`.`id` = `articles_tags`.`article_id` "
                             "INNER JOIN `tags` ON `tags`.`id` = `articles_tags`.`tag_id` "
                             "WHERE `articles_tags`.`tag_id` = ?", FakeDB.SQLS[3])
        ...
        with self.mock_db():
            ...
            self.assertEqual(3, len(FakeDB.SQLS))
            self.assertEqual("SELECT * FROM `tags`", FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `articles_tags` WHERE `tag_id` IN (?, ?, ?)', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `articles` WHERE `id` IN (?, ?, ?, ?, ?, ?, ?, ?)', FakeDB.SQLS[2])
    ...
    def test_include_has_one_and_has_many(self):
        ...
        with self.mock_db():
            ...
            self.assertEqual('SELECT * FROM `users`', FakeDB.SQLS[0])
            self.assertEqual('SELECT * FROM `mobiles` WHERE `user_id` IN (?, ?)', FakeDB.SQLS[1])
            self.assertEqual('SELECT * FROM `cars` WHERE `user_id` IN (?, ?)', FakeDB.SQLS[2])
