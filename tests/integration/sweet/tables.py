from sweet.model.schema._column import Column, ColumnKind, Columns, Table


users_roles_table = Table('user_roles', Columns([
    Column(name='user_id', kind=ColumnKind.Integer),
    Column(name='role_id', kind=ColumnKind.Integer),
    # Column(name='user_id', kind=ColumnType.Integer, ForeignKey('users.id'), primary_key=True),
    # Column(name='role_id', kind=ColumnType.Integer, ForeignKey('roles.id'), primary_key=True),
]))
