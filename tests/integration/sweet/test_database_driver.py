...
class TestInsertAndSelect:
    ...
    async def test_mysql(self, mysql_env):
        try:
            ...
            await mysql_env.db.execute("""DROP TABLE IF EXISTS foos;""")
    ...
    async def test_sqlite(self, sqlite_env):
        try:
            ...
            await sqlite_env.db.execute("""DROP TABLE IF EXISTS foos;""")
    ...
    async def test_pg(self, pg_env):
        ...
        try:
            ...
            await pg_env.db.execute("""DROP TABLE IF EXISTS foos;""")
