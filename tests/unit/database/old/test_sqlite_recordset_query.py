...
from sweet.database import WhereClause
...
class TestSQLiteRecordsetQuery(unittest.TestCase):
    ...
    def test_copy_deep(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` = ? AND `name` = ?', sql)
    ...
    def test_where_2(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `users`.`id` = ? AND `users`.`name` = ?', sql)
        self.assertEqual([1, 'Ryan'], params)
    ...
    def test_where_in(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `name` = ?', sql)
    ...
    def test_where_not_in(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` NOT IN (?, ?, ?) AND `name` <> ?', sql)
        self.assertEqual([1, 2, 3, 'Ryan'], params)

    def test_where_like(self):
        sql, params = self.get_recordset().select('*').where(id=[1, 2, 3], name__like='%yanpo%')._query_sql()
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `name` LIKE ?', sql)
    ...
    def test_where_not_like(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `name` NOT LIKE ?', sql)
        self.assertEqual([1, 2, 3, '%yanpo%'], params)
    ...
    def test_where_null(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `name` IS NULL', sql)
    ...
    def test_where_not_null(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `name` IS NOT NULL', sql)
        self.assertEqual([1, 2, 3], params)

    def test_where_gt(self):
        sql, params = self.get_recordset().select('*').where(id=[1, 2, 3], age__gt=30)._query_sql()
        self.assertEqual('SELECT * FROM `users` WHERE `id` IN (?, ?, ?) AND `age` > ?', sql)
    ...
    def test_where_between(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` BETWEEN ? AND ?', sql)
    ...
    def test_where_not_between(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` NOT BETWEEN ? AND ?', sql)
        self.assertEqual([1, 2], params)
    ...
    def test_or(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` = ? OR `name` = ?', sql)
        self.assertEqual([1, 'Ryan'], params)
    ...
    def test_or_between(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `name` = ? OR `id` BETWEEN ? AND ?', sql)
    ...
    def test_having_between(self):
        ...
        self.assertEqual('SELECT * FROM `users` HAVING `id` BETWEEN ? AND ?', sql)
        self.assertEqual([1, 2], params)
    ...
    def test_or_having_not_between(self):
        ...
        self.assertEqual('SELECT * FROM `users` HAVING `name` = ? OR `id` NOT BETWEEN ? AND ?', sql)
        self.assertEqual(['Ryan', 1, 2], params)
    ...
    def test_or_having_not_null(self):
        ...
        self.assertEqual('SELECT * FROM `users` HAVING `id` IN (?, ?, ?) OR `name` IS NOT NULL', sql)
        self.assertEqual([1, 2, 3], params)

    def test_or_having_not_in(self):
        sql, params = self.get_recordset().select('*').or_having(id__not=[1, 2, 3], name__not='Ryan')._query_sql()
        self.assertEqual('SELECT * FROM `users` HAVING `id` NOT IN (?, ?, ?) OR `name` <> ?', sql)
        self.assertEqual([1, 2, 3, 'Ryan'], params)
    ...
    def test_join(self):
        ...
        self.assertEqual('SELECT `users`.`id`, `users`.`name`, `cars`.`name` FROM `users` INNER JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ? AND `cars`.`name` = ?', sql)
    ...
    def test_join_without_select(self):
        ...
        self.assertEqual('SELECT * FROM `users` INNER JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ? AND `cars`.`name` = ?', sql)
        self.assertEqual([ 1, 2, 3, 'Ryan', 'focus'], params)
    ...
    def test_join_with_function(self):
        ...
        self.assertEqual('SELECT * FROM `users` INNER JOIN `cars` ON `users`.`id` = `cars`.`user_id` AND `cars`.`id` = ? OR `users`.`id` = ?', sql)
    ...
    def test_left_join(self):
        ...
        self.assertEqual('SELECT `users`.`id`, `users`.`name`, `cars`.`name` FROM `users` LEFT JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ?', sql)
        self.assertEqual([ 1, 2, 3, 'Ryan'], params)
    ...
    def test_right_join(self):
        ...
        self.assertEqual('SELECT `users`.`id`, `users`.`name`, `cars`.`name` FROM `users` RIGHT JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ?', sql)
        self.assertEqual([ 1, 2, 3, 'Ryan'], params)
    ...
    def test_cross_join(self):
        ...
        self.assertEqual('SELECT `users`.`id`, `users`.`name`, `cars`.`name` FROM `users` CROSS JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ?', sql)
        self.assertEqual([ 1, 2, 3, 'Ryan'], params)

    def test_count(self):
        def _(sql, *params):
            self.assertEqual('SELECT COUNT(*) AS aggregate FROM `users` WHERE `name` <> ?', sql)
    ...
    def test_count_with_column(self):
        def _(sql, *params):
            self.assertEqual('SELECT COUNT(`id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 2})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_count_distinct_with_column(self):
        def _(sql, *params):
            self.assertEqual('SELECT COUNT(DISTINCT `id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 2})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_max(self):
        def _(sql, *params):
            self.assertEqual('SELECT MAX(`id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
    ...
    def test_max_distinct(self):
        def _(sql, *params):
            self.assertEqual('SELECT MAX(DISTINCT `id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 1024})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_min(self):
        def _(sql, *params):
            self.assertEqual('SELECT MIN(`id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
    ...
    def test_min_distinct(self):
        def _(sql, *params):
            self.assertEqual('SELECT MIN(DISTINCT `id`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 1})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_avg(self):
        def _(sql, *params):
            self.assertEqual('SELECT AVG(`age`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
    ...
    def test_avg_distinct(self):
        def _(sql, *params):
            self.assertEqual('SELECT AVG(DISTINCT `age`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 32})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_sum(self):
        def _(sql, *params):
            self.assertEqual('SELECT SUM(`age`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
    ...
    def test_sum_distinct(self):
        def _(sql, *params):
            self.assertEqual('SELECT SUM(DISTINCT `age`) AS aggregate FROM `users` WHERE `name` <> ?', sql)
            self.assertEqual(['Lily'], list(params))
            return mydict({'aggregate': 2048})
        tb = self.get_recordset()
        tb.db.fetchone = _
    ...
    def test_read_lock(self):
        ...
        self.assertEqual('SELECT `users`.`id`, `cars`.`name` FROM `users` LEFT JOIN `cars` ON `users`.`id` = `cars`.`user_id` WHERE `id` IN (?, ?, ?) OR `name` = ?', sql)
        self.assertEqual([ 1, 2, 3, 'Ryan'], params)
    ...
    def test_where_exists(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `age` <= ? AND EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)', sql)
    ...
    def test_multiple_where_exists(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?) AND EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)', sql)
    ...
    def test_or_exists(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `age` <= ? OR EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)', sql)
        self.assertEqual([20, 'iphone'], params)
    ...
    def test_multiple_or_exists(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?) OR EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)', sql)
        self.assertEqual(['iphone', 'aphone'], params)
    ...
    def test_complex_where_or_exists(self):
        ...
        expected_sql = 'SELECT * FROM `users` WHERE `age` <= ?' \
              ' AND EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)' \
              ' OR EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)' \
              ' OR EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)' \
              ' AND EXISTS (SELECT * FROM `mobiles` WHERE `name` = ?)'
    ...
    def test_union_alls(self):
        ...
        self.assertEqual('SELECT * FROM `users` WHERE `id` = ? UNION ALL SELECT * FROM `users` WHERE `id` = ?', sql)
        self.assertEqual([1, 2], params)
