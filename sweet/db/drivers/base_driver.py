...
class BaseDriver(ABC):
    @abstractmethod
    @asynccontextmanager
    async def transaction(self) -> AsyncIterator[Transaction]: pass

    @abstractmethod
    async def execute_rowid(self, sql: str, *params: Any) -> Any: pass

    @abstractmethod
    async def execute_rowids(self, sql: str, params_seq: list[tuple]) -> list: pass

    @abstractmethod
    async def execute_rowcount(self, sql: str, *params: Any) -> int: pass

    @abstractmethod
    async def fetchone(self, sql: str, *params: Any) -> dict[str, Any] | None: pass

    @abstractmethod
    async def fetchall(self, sql: str, *params: Any) -> list[dict[str, Any]] | None: pass
